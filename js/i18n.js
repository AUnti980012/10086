...
(function () {
    ...
    const PAIRS = [
        // ---- 应用标题 / 署名 ----
        ['app.name', '反诈智能识别与报案辅助系统', 'Anti-Fraud Intelligent Recognition & Report-Filing Assistance System'],
        ['app.title', '反诈智能识别与报案辅助系统 · 东北电力大学', 'Anti-Fraud Intelligent Recognition & Report-Filing Assistance System · NEEPU'],
        ...
        ['app.univ', '东北电力大学', 'Northeast Electric Power University'],
        ['app.footer', '© 2026 反诈智能识别与报案辅助系统 | 创意来自东北电力大学易班工作站 | AI引擎: DeepSeek + Tesseract OCR 作者Xin PR,Liu A Green,Wang A Black 保留著作权', '© 2026 Anti-Fraud Intelligent Recognition & Report-Filing Assistance System | Concept by NEEPU YiBan Workstation | AI engine: DeepSeek + Tesseract OCR Authors: Xin PR, Liu A Green, Wang A Black All rights reserved'],
